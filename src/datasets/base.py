...
class Dataset(ABC):
    ...
    def get_remote_path(self):
        return st.remote_data_dir.format(BUCKET_NAME=st.bucket_name) + "/" + self.dataset + "/" + self.library
    ...
    def get_local(self, transforms=None, filtering=False, filtering_classes=None, distributed=False):
        pass

    def get_remote(self, transforms=None, filtering=False, filtering_classes=None, distributed=False):
        pass
